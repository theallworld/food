...
const sections = [
  ...
  ['五、存储、期限与删除', '餐食记录和照片保存在本机 IndexedDB；AI 教练聊天记录、部分档案、目标和设置保存在本机 LocalStorage。Android 版 API Key 使用 Android Keystore 加密后保存；其他运行环境由对应平台的本地存储机制保存。信息保留至你主动删除、清除本机数据或卸载应用；DeepSeek 接收到的信息依其官方政策处理。你可以在设置中清除全部本机记录、聊天记录、照片、身体档案、目标及 API Key。'],
